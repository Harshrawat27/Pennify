    ...
    <View className='flex-1'>
      ...
      >
            ...
            >
              ...
              <View className='flex-1 ml-3'>
                ...
                <Text className='text-[12px] text-neutral-400 mt-0.5'>
                  Target: {getCurrencySymbol(currency)}
                  {g.target}
                </Text>
              </View>
        ...
        >
          ...
          <Text className='text-[14px] font-medium text-neutral-400'>
            Add Goal
          </Text>
        </Pressable>
        ...
        >
          <View className='flex-1 bg-neutral-50'>
            ...
            <View className='flex-row items-center justify-between px-6 py-4'>
              <Text className='text-[20px] font-bold text-black'>Add Goal</Text>
              <Pressable
                onPress={closeForm}
                ...
                {GOAL_ICONS.map((item) => (
                  <Pressable
                    ...
                    className={`w-12 h-12 rounded-xl items-center justify-center ${
                      newIcon === item.icon ? 'bg-black' : 'bg-white'
                    }`}
                  >
                    <Feather
                      name={item.icon}
                      size={20}
                      color={newIcon === item.icon ? '#fff' : '#000'}
                    />
                  </Pressable>
                ))}
              </View>
